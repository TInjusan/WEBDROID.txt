 ...
 * There are two subclass ElementNode for HTML object and XMLNode for XML object.
 * ArrayList is used to store stream of objects both for HTML and XML.
...
public class SymbolTable {
    ...
    /**
     * Class for HTML node object during syntax analysis.
     */
    public class ElementNode {
        ...
        void addUDP(String property, String value) {
            this.UDP.put(property, value);
        }
        void removeUDP(String property) {
            this.UDP.remove(property);
        }
 
        void setTag(String tag) { this.Tag = tag; }
        String getTag()         { return Tag;     }

        void setElement_type(HTML_CODE element_type) {
            this.Element_type = element_type;
        }
        HTML_CODE getElement_type() {
            return Element_type;
        }
        ...
        void setChildrenElement(List<ElementNode> c) {
            this.Children_element = c;
        }
        List<ElementNode> getChildrenElement() {
            return Children_element;
        }
    }
    
    /**
     * Class for translated XML node object
    ...
    public class XML_node {
        ...
        void setXMLUDP(HashMap<String, String> udp) {
            this.xml_udp = udp;
        }
        void addXMLUDP(String property, String value) {
            this.xml_udp.put(property, value);
        }
        ...
        void setChildrenElement(List<XML_node> c) {
            this.Children_element = c;
        }
        List<XML_node> getChildrenElement() {
            return Children_element;
        }
